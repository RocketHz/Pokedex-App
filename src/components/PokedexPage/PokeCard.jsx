...
const PokeCard = ({ url }) => {
  ...
  return (
    <article className='poke_card' onClick={handleNavigate}>
      <div className='poke_card_background'></div>
      <header>
